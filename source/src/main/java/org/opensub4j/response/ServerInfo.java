...
public class ServerInfo {
    ...
    public ServerInfo(int loggedInUsersNo, int onlineProgramUsersNo, int onlineTotalUsersNo, String application, String contact, int moviesAKANo, int moviesTotalNo, int subsDownloadsNo, int subsFileNo, int subsLangsNo, int usersMaxAllTime, int usersRegistered, String websiteURL, String xmlRpcURL, double xmlRpcVersion) {
